...
import {FullMulDiv} from "src/lib/pool/FullMulDiv.sol";
...
library Math {
        ...
        returns (uint256 amount0)
    {
        ...
        if (roundUp) {
            ...
            amount0 = FullMulDiv.mulDiv(numerator1, numerator2, sqrtPriceBX96) / sqrtPriceAX96;
        }
    }
        ...
        returns (uint256 amount1)
    {
        ...
        if (roundUp) {
            ...
            amount1 = FullMulDiv.mulDiv(liquidity, (sqrtPriceBX96 - sqrtPriceAX96), FixedPoint96.Q96);
        }
    }
    ...
    function getNextSqrtPriceFromAmount1RoundingDown(uint160 sqrtPriceX96, uint128 liquidity, uint256 amountIn)
        ...
        returns (uint160)
    {
        return uint160(uint256(sqrtPriceX96) + FullMulDiv.mulDiv(amountIn, FixedPoint96.Q96, liquidity));
    }

    function mulDivRoundingUp(uint256 a, uint256 b, uint256 denominator) internal pure returns (uint256 result) {
        result = FullMulDiv.mulDiv(a, b, denominator);
